@extends('layout')
  ...
  <div class="container-fluid">
      ...
      <!-- Page Heading -->
      <h1 class="h3 mb-4 text-gray-800">Add Expenditure</h1>
      <form method="post" action="{{route('post_expenditure')}}"> 
          @csrf
       
          <div class="form-group row">
          <div class="col-sm-6 mb-3 mb-sm-0">
                  <input type="text" name="purpose" class="form-control form-control-user" id="exampleFirstName" placeholder="Purpose">
              </div>
