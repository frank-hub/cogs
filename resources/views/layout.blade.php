    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Job Type:</h6>
                        <a class="collapse-item" href="{{url('jobtype/add')}}">Add Job Type</a>
                        <a class="collapse-item" href="{{url('jobtype/view')}}">View Job Type</a>
                    </div>
                    <div class="bg-white py-2 collapse-inner rounded">
            ...
            <li class="nav-item">
                ...
                <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{url('loan/add')}}">Add Loan</a>
                        <a class="collapse-item" href="{{url('loan/view')}}">View Loan</a>
                    </div>
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Expenditure:</h6>
                        <a class="collapse-item" href="{{url('expenditure/add')}}">Add Expenditure</a>
                        <a class="collapse-item" href="{{url('expenditure/view')}}">View Expenditure</a>
                    </div>
